    ...
    <style>
        * {
        ...
        .login-container label {
            ...
            margin-top: 10px; /* Add spacing between inputs and labels */
    ...
    <div class="login-wrapper">
        <div class="login-container">
            ...
            <form action="checkadminlogin" method="post">
                ...
                <input type="text" name="auname" placeholder="Username" required><br>
                <label>Enter Password</label>
                <input type="password" name="apwd" placeholder="Password" required><br>
